...
namespace Dominio
{
    public class Sistema
    {
        ...
        #region Instancia
        //Instanciamos la clase sistema.
        public static int ValorVIP { get; set; }
        ...
        #endregion
        #region Listas
        //Instanciamos las listas que seran usadas en el correr de la aplicacion.
        ...
        #region Metodos
        //Estos metodos fueron otorgados en el obligatorio para realizar la precarga.
        ...
        //Creamos una funcion InicializarSistema para cuando ingresemos a la App se precargue todo lo necesario para su funcionamiento.
        ...
        private List<Seleccion> buscarSelecciones(string nombre1, string nombre2)
        {
            List<Seleccion> SeleccionesDePartido = new List<Seleccion>();
            foreach (Seleccion s in selecciones)
            {
                if (s.unPais.Nombre.Equals(nombre1) || s.unPais.Nombre.Equals(nombre2))
                {
                    SeleccionesDePartido.Add(s);
                }
            }
            return SeleccionesDePartido;
        }
        ...
        //Aca se encuentran los metodos de Alta de: Seleccion, Pais, Jugador, Incidencia, Partido, Periodista
        private void AltaSeleccion(Seleccion seleccion)
        {
        ...
        private void AltaIncidencia(Incidencia incidencia)
        {
            this.incidencias.Add(incidencia);
        }
        private void AltaPartido(Partido partido)
        {
            this.Partidos.Add(partido);
        }
        private void AltaPeriodistas(Periodista periodista)
        {
            this.periodistas.Add(periodista);
        }
        #endregion
        #region Jugadores
        //Precarga de los jugadores.
        ...
        #endregion
        #region Incidencias
        //Precarga de las incidencias
        private void PrecargaIncidencias()
        {
            //Grupo A

            /*Partido1*/
            AltaIncidencia(new Incidencia(GetJugador(36),  "Gol", 67, GetPartido(1)));
            AltaIncidencia(new Incidencia(GetJugador(477), "Gol", 72, GetPartido(1)));
            AltaIncidencia(new Incidencia(GetJugador(472), "Amonestacion", 73, GetPartido(1)));
            AltaIncidencia(new Incidencia(GetJugador(456), "Gol", 75, GetPartido(1)));
            AltaIncidencia(new Incidencia(GetJugador(459), "Gol", 77, GetPartido(1)));
            /*Partido2*/
            AltaIncidencia(new Incidencia(GetJugador(36),  "Gol", 5, GetPartido(2)));
            AltaIncidencia(new Incidencia(GetJugador(477), "Gol", 37, GetPartido(2)));
            AltaIncidencia(new Incidencia(GetJugador(456), "Gol", 45, GetPartido(2)));
            AltaIncidencia(new Incidencia(GetJugador(451), "Expulsion", 45, GetPartido(2)));
            /*Partido3*/
            AltaIncidencia(new Incidencia(GetJugador(36), "Gol", 80, GetPartido(3)));
            AltaIncidencia(new Incidencia(GetJugador(477), "Gol", 87, GetPartido(3)));
            AltaIncidencia(new Incidencia(GetJugador(478), "Expulsion", 90, GetPartido(3)));
            AltaIncidencia(new Incidencia(GetJugador(456), "Gol", 93, GetPartido(3)));
            /*Partido4*/
            AltaIncidencia(new Incidencia(GetJugador(460), "Gol", 14, GetPartido(4)));
            AltaIncidencia(new Incidencia(GetJugador(460), "Gol", 78, GetPartido(4)));
            AltaIncidencia(new Incidencia(GetJugador(459), "Amonestacion", 85, GetPartido(4)));
            AltaIncidencia(new Incidencia(GetJugador(478), "Gol", 89, GetPartido(4)));
            /*Partido5*/
            AltaIncidencia(new Incidencia(GetJugador(460), "Gol", 55, GetPartido(5)));
            AltaIncidencia(new Incidencia(GetJugador(476), "Gol", 67, GetPartido(5)));
            AltaIncidencia(new Incidencia(GetJugador(475), "Expulsion", 76, GetPartido(5)));
            AltaIncidencia(new Incidencia(GetJugador(470), "Gol", 78, GetPartido(5)));
            AltaIncidencia(new Incidencia(GetJugador(594), "Gol", 90, GetPartido(5)));
            /*Partido6*/
            AltaIncidencia(new Incidencia(GetJugador(462), "Gol", 13, GetPartido(6)));
            AltaIncidencia(new Incidencia(GetJugador(462), "Amonestacion", 13, GetPartido(6)));
            /*Partido7*/
            AltaIncidencia(new Incidencia(GetJugador(575), "Gol", 78, GetPartido(7)));
            AltaIncidencia(new Incidencia(GetJugador(55),  "Gol", 89, GetPartido(7)));
            AltaIncidencia(new Incidencia(GetJugador(55),  "Gol", 92, GetPartido(7)));
            AltaIncidencia(new Incidencia(GetJugador(55),  "Expulsion", 92, GetPartido(7)));
            /*Partido8*/
            AltaIncidencia(new Incidencia(GetJugador(470), "Gol", 72, GetPartido(8)));
            AltaIncidencia(new Incidencia(GetJugador(278), "Gol", 80, GetPartido(8)));
            AltaIncidencia(new Incidencia(GetJugador(278), "Expulsion", 89, GetPartido(8)));
            AltaIncidencia(new Incidencia(GetJugador(470), "Expulsion", 89, GetPartido(8)));
            /*Partido9*/
            AltaIncidencia(new Incidencia(GetJugador(579), "Gol", 9, GetPartido(9)));
            AltaIncidencia(new Incidencia(GetJugador(340), "Gol", 87, GetPartido(9)));
            AltaIncidencia(new Incidencia(GetJugador(577), "Amonestacion", 87, GetPartido(9)));
            /*Partido10*/
            AltaIncidencia(new Incidencia(GetJugador(55),  "Gol", 11, GetPartido(10)));
            AltaIncidencia(new Incidencia(GetJugador(35),  "Gol", 35, GetPartido(10)));
            AltaIncidencia(new Incidencia(GetJugador(55),  "Amonestacion", 35, GetPartido(10)));
            AltaIncidencia(new Incidencia(GetJugador(51),  "Gol", 80, GetPartido(10)));
            AltaIncidencia(new Incidencia(GetJugador(341), "Gol", 86, GetPartido(10)));
            AltaIncidencia(new Incidencia(GetJugador(55),  "Expulsion", 87, GetPartido(10)));
            /*Partido11*/
            AltaIncidencia(new Incidencia(GetJugador(475), "Gol", 78, GetPartido(11)));
            AltaIncidencia(new Incidencia(GetJugador(473), "Amonestacion", 82, GetPartido(11)));
            AltaIncidencia(new Incidencia(GetJugador(473), "Expulsion", 85, GetPartido(11)));
            AltaIncidencia(new Incidencia(GetJugador(475), "Amonestacion", 85, GetPartido(11)));
            /*Partido12*/
            AltaIncidencia(new Incidencia(GetJugador(594), "Gol", 17, GetPartido(12)));
            AltaIncidencia(new Incidencia(GetJugador(592), "Gol", 56, GetPartido(12)));
            AltaIncidencia(new Incidencia(GetJugador(339), "Gol", 77, GetPartido(12)));
            AltaIncidencia(new Incidencia(GetJugador(339), "Amonestacion", 77, GetPartido(12)));

            //Grupo B

            /*Partido13*/
            AltaIncidencia(new Incidencia(GetJugador(269), "Gol", 64, GetPartido(13)));
            AltaIncidencia(new Incidencia(GetJugador(278), "Gol", 69, GetPartido(13)));
            AltaIncidencia(new Incidencia(GetJugador(271), "Gol", 87, GetPartido(13)));
            AltaIncidencia(new Incidencia(GetJugador(348), "Gol", 90, GetPartido(13)));
            AltaIncidencia(new Incidencia(GetJugador(277), "Amonestacion", 90, GetPartido(13)));
            /*Partido14*/
            AltaIncidencia(new Incidencia(GetJugador(269), "Gol", 5, GetPartido(14)));
            AltaIncidencia(new Incidencia(GetJugador(268), "Expulsion", 89, GetPartido(14)));
            /*Partido15*/
            AltaIncidencia(new Incidencia(GetJugador(270), "Gol", 23, GetPartido(15)));
            AltaIncidencia(new Incidencia(GetJugador(281), "Gol", 34, GetPartido(15)));
            AltaIncidencia(new Incidencia(GetJugador(281), "Amonestacion", 84, GetPartido(15)));
            /*Partido16*/
            AltaIncidencia(new Incidencia(GetJugador(286), "Gol", 12, GetPartido(16)));
            AltaIncidencia(new Incidencia(GetJugador(287), "Gol", 20, GetPartido(16)));
            AltaIncidencia(new Incidencia(GetJugador(349), "Gol", 40, GetPartido(16)));
            /*Partido17*/
            AltaIncidencia(new Incidencia(GetJugador(790), "Gol", 12, GetPartido(17)));
            /*Partido18*/
            AltaIncidencia(new Incidencia(GetJugador(371), "Gol", 58, GetPartido(18)));
            AltaIncidencia(new Incidencia(GetJugador(769), "Gol", 81, GetPartido(18)));
            AltaIncidencia(new Incidencia(GetJugador(769), "Expulsion", 91, GetPartido(18)));
            /*Partido19*/
            AltaIncidencia(new Incidencia(GetJugador(371), "Gol", 78, GetPartido(19)));
            AltaIncidencia(new Incidencia(GetJugador(770), "Gol", 89, GetPartido(19)));
            /*Partido20*/
            AltaIncidencia(new Incidencia(GetJugador(813), "Gol", 42, GetPartido(20)));
            AltaIncidencia(new Incidencia(GetJugador(813), "Expulsion", 51, GetPartido(20)));
            AltaIncidencia(new Incidencia(GetJugador(810), "Amonestacion", 63, GetPartido(20)));
            AltaIncidencia(new Incidencia(GetJugador(810), "Gol", 64, GetPartido(20)));
            /*Partido21*/
            AltaIncidencia(new Incidencia(GetJugador(288), "Gol", 9, GetPartido(21)));
            /*Partido22*/
            AltaIncidencia(new Incidencia(GetJugador(789), "Gol", 11, GetPartido(22)));
            AltaIncidencia(new Incidencia(GetJugador(812), "Gol", 35, GetPartido(22)));
            /*Partido23*/
            AltaIncidencia(new Incidencia(GetJugador(276), "Gol", 78, GetPartido(23)));
            /*Partido24*/
            AltaIncidencia(new Incidencia(GetJugador(813), "Gol", 17, GetPartido(24)));
            AltaIncidencia(new Incidencia(GetJugador(799), "Amonestacion", 42, GetPartido(24)));
            AltaIncidencia(new Incidencia(GetJugador(813), "Gol", 56, GetPartido(24)));
            AltaIncidencia(new Incidencia(GetJugador(800), "Gol", 77, GetPartido(24)));
            AltaIncidencia(new Incidencia(GetJugador(800), "Expulsion", 87, GetPartido(24)));
            //Semis
            AltaIncidencia(new Incidencia(GetJugador(451), "Amonestacion", 10, GetPartido(25)));
            AltaIncidencia(new Incidencia(GetJugador(478), "Amonestacion", 61, GetPartido(25)));
            AltaIncidencia(new Incidencia(GetJugador(800), "Amonestacion", 78, GetPartido(25)));
            AltaIncidencia(new Incidencia(GetJugador(456), "Expulsion", 92, GetPartido(25)));
            AltaIncidencia(new Incidencia(GetJugador(451), "Gol", -1, GetPartido(25)));
            AltaIncidencia(new Incidencia(GetJugador(457), "Gol", -1, GetPartido(25)));
            AltaIncidencia(new Incidencia(GetJugador(478), "Gol", -1, GetPartido(25)));
            AltaIncidencia(new Incidencia(GetJugador(799), "Gol", -1, GetPartido(25)));
            AltaIncidencia(new Incidencia(GetJugador(800), "Gol", -1, GetPartido(25)));
            /*Partido25*/
            AltaIncidencia(new Incidencia(GetJugador(279), "Gol", 78, GetPartido(26)));
            AltaIncidencia(new Incidencia(GetJugador(278), "Amonestacion", 86, GetPartido(26)));
            AltaIncidencia(new Incidencia(GetJugador(278), "Expulsion", 90, GetPartido(26)));
            AltaIncidencia(new Incidencia(GetJugador(812), "Amonestacion", 90, GetPartido(26)));
            //Final
            AltaIncidencia(new Incidencia(GetJugador(460), "Gol", 67, GetPartido(27)));
            AltaIncidencia(new Incidencia(GetJugador(288), "Amonestacion", 70, GetPartido(27)));
            AltaIncidencia(new Incidencia(GetJugador(288), "Gol", 80, GetPartido(27)));
            AltaIncidencia(new Incidencia(GetJugador(288), "Expulsion", 81, GetPartido(27)));
            AltaIncidencia(new Incidencia(GetJugador(262), "Gol", 89, GetPartido(27)));
        }
        #endregion
        #region Partidos
        //Precarga de los partidos.
        private void PrecargaPartidos()
        {
            /*********************************************************GRUPO A*********************************************************/

            AltaPartido(new Partido(1, buscarSelecciones("Catar", "Ecuador"), DateTime.Parse("2022-11-07 07:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(2, buscarSelecciones("Catar", "Senegal"), DateTime.Parse("2022-11-08 10:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(3, buscarSelecciones("Catar", "Países Bajos"), DateTime.Parse("2022-11-09 13:00:00"), "Finalizado", "Fase de grupos"));

            AltaPartido(new Partido(4, buscarSelecciones("Ecuador", "Catar"), DateTime.Parse("2022-11-10 16:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(5, buscarSelecciones("Ecuador", "Senegal"), DateTime.Parse("2022-11-11 07:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(6, buscarSelecciones("Ecuador", "Países Bajos"), DateTime.Parse("2022-11-12 13:00:00"), "Finalizado", "Fase de grupos"));

            AltaPartido(new Partido(7, buscarSelecciones("Senegal", "Catar"), DateTime.Parse("2022-11-10 07:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(8, buscarSelecciones("Senegal", "Ecuador"), DateTime.Parse("2022-11-11 16:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(9, buscarSelecciones("Senegal", "Países Bajos"), DateTime.Parse("2022-11-12 10:00:00"), "Finalizado", "Fase de grupos"));

            AltaPartido(new Partido(10, buscarSelecciones("Países Bajos", "Catar"), DateTime.Parse("2022-11-10 07:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(11, buscarSelecciones("Países Bajos", "Ecuador"), DateTime.Parse("2022-11-11 10:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(12, buscarSelecciones("Países Bajos", "Senegal"), DateTime.Parse("2022-11-12 13:00:00"), "Finalizado", "Fase de grupos"));

            /*********************************************************GRUPO B*********************************************************/

            AltaPartido(new Partido(13, buscarSelecciones("Inglaterra", "Iran"), DateTime.Parse("2022-11-07 07:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(14, buscarSelecciones("Inglaterra", "Gales"), DateTime.Parse("2022-11-08 16:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(15, buscarSelecciones("Inglaterra", "Estados Unidos"), DateTime.Parse("2022-11-09 13:00:00"), "Finalizado", "Fase de grupos"));

            AltaPartido(new Partido(16, buscarSelecciones("Irán", "Inglaterra"), DateTime.Parse("2022-11-10 16:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(17, buscarSelecciones("Irán", "Gales"), DateTime.Parse("2022-11-11 07:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(18, buscarSelecciones("Irán", "Estados Unidos"), DateTime.Parse("2022-11-12 16:00:00"), "Finalizado", "Fase de grupos"));

            AltaPartido(new Partido(19, buscarSelecciones("Estados Unidos", "Irán"), DateTime.Parse("2022-11-10 16:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(20, buscarSelecciones("Estados Unidos", "Gales"), DateTime.Parse("2022-11-11 07:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(21, buscarSelecciones("Estados Unidos", "Inglaterra"), DateTime.Parse("2022-11-12 16:00:00"), "Finalizado", "Fase de grupos"));

            AltaPartido(new Partido(22, buscarSelecciones("Gales", "Irán"), DateTime.Parse("2022-11-10 07:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(23, buscarSelecciones("Gales", "Inglaterra"), DateTime.Parse("2022-11-11 16:00:00"), "Finalizado", "Fase de grupos"));
            AltaPartido(new Partido(24, buscarSelecciones("Gales", "Estados Unidos"), DateTime.Parse("2022-11-12 10:00:00"), "Finalizado", "Fase de grupos"));

            /*********************************************************Octavos*********************************************************/

            AltaPartido(new Partido(25, buscarSelecciones("Ecuador", "Gales"), DateTime.Parse("2022-12-03 12:00:00"), "Finalizado", "Semis"));
            AltaPartido(new Partido(26, buscarSelecciones("Inglaterra", "Países Bajos"), DateTime.Parse("2022-12-04 16:00:00"), "Finalizado", "Semis"));

            /*********************************************************Final*********************************************************/

            AltaPartido(new Partido(27, buscarSelecciones("Inglaterra", "Ecuador"), DateTime.Parse("2022-12-18 12:00:00"), "Finalizado", "Final"));
        ...
        #endregion
        #region Periodista
        //Precarga Periodistas.
        private void PrecargaPeriodista()
        {
            AltaPeriodistas(new Periodista("Juan Perez", "JuanPerez@gmail.com", "JuanPerez1972"));
            AltaPeriodistas(new Periodista("Juan Alvez", "AlvezJuan@gmail.com", "Alvez4233"));
            AltaPeriodistas(new Periodista("Alberto Blezi", "b123Blazi@gmail.com", "AlbertoBleeeeez1"));
            AltaPeriodistas(new Periodista("Hector Laguna", "lagunaHector@gmail.com", "Perro6643"));
            AltaPeriodistas(new Periodista("Diego Piriz", "PirizD@gmail.com", "Diegote1566"));
            AltaPeriodistas(new Periodista("Juan Som", "JuanSomm@gmail.com", "JuanJuanSom221"));
            AltaPeriodistas(new Periodista("Juan Villamil", "JuanVillamil@gmail.com", "Villamil555"));
            AltaPeriodistas(new Periodista("Juan Laguna", "LJuan@gmail.com", "JuanLLagun..2"));
            AltaPeriodistas(new Periodista("Santiago Caceres", "SCaceres@gmail.com", "SCACERES@@@"));
            AltaPeriodistas(new Periodista("Milena Viscardi", "Viscardi42@gmail.com", "VisM22"));

        }
        #endregion
        #endregion

        #region ValorReferencia(2)
        //Este metodo hace referencia al punto 2.2 del obligatorio.
        public void ValorReferencia(decimal valorReferencia)
        {
            foreach (Jugador unJugador in Jugadores)
            {
                if (unJugador.Valor >= valorReferencia)         //Incluimos la igualdad
                {
                    unJugador.Categoria = "VIP";
                }
                else
                {
                    unJugador.Categoria = "Estandar";
                }
            }
        }
        #endregion
        #region Listar partidos(3)
        //Este metodo hace referencia al punto 2.3 del obligatorio.
        public List<Partido> ListarPartidos(int id)
        {

            List<Partido> retorno = new List<Partido>();
            Pais jugadorPais = null;
            foreach (Jugador j in Jugadores)
            {
                if (j.Id == id)
                {
                    jugadorPais = j.unPais;
                }
            ...
            if (jugadorPais != null)
            {
                foreach (Partido p in Partidos)
                {
                    ...
                    {
                        if (s.unPais.Nombre.Equals(jugadorPais.Nombre))
                            retorno.Add(p);
                    }
                }
            }
        ...
        #endregion
        #region ListarJugadoresExpulsados(4)
        //Este metodo hace referencia al punto 2.4 del obligatorio.
        public List<Jugador> ListarJugadoresExpulsados()
        {
            List<Jugador> AuxiliarExpulsiones = new List<Jugador>();
            foreach (Incidencia i in Incidencias)
            {
                foreach (Jugador j in jugadores)
                {
                    if (i.unJugador.Equals(j) && i.Tipo.Equals("Expulsion"))
                    {
                        if (!AuxiliarExpulsiones.Contains(j)) AuxiliarExpulsiones.Add(j);
                    }
                }
            }
            if(AuxiliarExpulsiones.Count == 0)
            {
                throw new Exception("No se encontraron registros");
            }
            AuxiliarExpulsiones.Sort();         //Ordena la lista segun el criterio de Jugador.compareTo()
            return AuxiliarExpulsiones;
        }
        #endregion
        #region ListarPartidosConMasGoles(5)
        //Este metodo hace referencia al punto 2.5 del obligatorio.
        public Partido ListarPartidosConMasGoles(string nombreSeleccion)
        {
            Partido partidoConMasGoles = null;
            Seleccion SeleccionEncontrado = null;
            List<Incidencia> auxIncidencias = new List<Incidencia>(); 
            int GolesEncontrados = 0;
            
            foreach (Seleccion s in selecciones)
            {
                if (s.unPais.Nombre.ToLower().Equals(nombreSeleccion.ToLower())) 
                {
                    SeleccionEncontrado = s;
                }
            }
            if (SeleccionEncontrado != null)
            {
                foreach (Partido p in partidos)
                {
                    if (p.selecciones.Contains(SeleccionEncontrado))
                    {
                        foreach (Incidencia i in incidencias)
                        {
                            if (i.unPartido.Equals(p) && i.Tipo.Equals("Gol"))
                            {
                                auxIncidencias.Add(i);
                            }
                        }
                        if (auxIncidencias.Count > GolesEncontrados)
                        {
                            GolesEncontrados = auxIncidencias.Count; //Ya que se sabe que las incidencias de la lista son unicamente goles
                            partidoConMasGoles = p;
                        }
                    }
                }
            }
            else throw new Exception("La seleccion no participo en ningun partido o esta mal escrita");

            return partidoConMasGoles;
        }

        #endregion
        #region ListarJugadoresConGoles(6)
        //Este metodo hace referencia al punto 2.5 del obligatorio.
        public List<Jugador> ListarJugadoresConGoles()
        {
            List<Jugador> AuxJugadoresConGoles = new List<Jugador>();
            foreach (Incidencia i in incidencias)
            {
                if (i.Tipo.Equals("Gol"))
                {
                    if (!AuxJugadoresConGoles.Contains(i.unJugador))        // Verifica que el jugador no este ya en la lista ya que nos interesa saber que jugadores hicieron goles, no cuantos goles
                    {
                        AuxJugadoresConGoles.Add(i.unJugador);
                    }
                }
            }
            return AuxJugadoresConGoles;
        }
        #endregion
        #region ListarIncidenciasPorPartido(7)
        //Este metodo hace referencia al punto 2.6 del obligatorio.
        public List<Incidencia> ListarIncidenciasPorPartido(Partido partido)
        {

            List<Incidencia> retorno = new List<Incidencia>();            
            foreach (Incidencia i in incidencias)
            {
                if (i.unPartido.Equals(partido))
                    retorno.Add(i);
            }
            return retorno;
        }
